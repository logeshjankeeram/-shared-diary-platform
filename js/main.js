...
class DiaryUI {
    ...
    async createDiary() {
        ...
        if (!this.validateInputs(diaryId, userName)) return;

        try {
            this.showLoading('Creating diary...');
            const result = await window.diaryDB.createDiary(diaryId, userName, diaryType);
    ...
    async joinDiary() {
        ...
        try {
            ...
            const result = await window.diaryDB.joinDiary(diaryId, userName);
    ...
    validateInputs(diaryId, userName) {
        if (!diaryId) {
